...
def main(hparams):
    ...
    vae = VAEhierSingleDecoder(nc=3, decoder_dist='gaussian', latent_dim_level0=int(hparams.latent_dim_level0),
    ...
    wandb_logger = WandbLogger(
        name=f'Single_decoder: ds {hparams.dataset} | '
             f'{hparams.name}|'
    ...
    epoch_end_example_image_1 = ImagePredictionLoggerSingleDecoder(sample=15, ds=ds, wandb_logger=wandb_logger)
    epoch_end_example_image_2 = ImagePredictionLoggerSingleDecoder(sample=4, ds=ds, wandb_logger=wandb_logger)
    epoch_end_example_image_1_hierarchy = ImagePredictionLoggerHierarchySingleDecoder(sample=4, ds=ds, wandb_logger=wandb_logger)
    epoch_end_example_image_2_hierarchy = ImagePredictionLoggerHierarchySingleDecoder(sample=15, ds=ds, wandb_logger=wandb_logger)
    epoch_end_example_latent_1 = ImagePredictionLoggerLatentActivationSingleDecoder(sample=4, ds=ds, wandb_logger=wandb_logger)
